...
export const card = (bill) => {
  ...
  const [firstName, lastName] = firstAndLastNames.includes('.') 
    ? firstAndLastNames.split('.') 
    : ['', firstAndLastNames];
...
export default class {
  constructor({ document, onNavigate, store, bills, localStorage }) {
    ...
    this.store = store;
    this.counter = {}; // Track counters for each status
    this.index = null; // Current index being processed
